...
export class UserRepository implements IUserRepository {
    ...
    async findByIdForProfile(id: string): Promise<any | null> {
        try {
            return await UserModel.findById(id)
                .select('firstName middleName lastName location experience birthday specializations rating bio email role placeWork contacts education stats isVerified createdAt updatedAt avatarId defaultAvatarPath documents workHistory') // добавили avatarId
