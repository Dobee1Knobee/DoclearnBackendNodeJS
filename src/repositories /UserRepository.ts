...
export class UserRepository implements IUserRepository {
    ...
    async findByIdForProfile(id: string): Promise<any | null> {
        try {
            return await UserModel.findById(id)
                .select('firstName lastName location experience birthday specialization rating bio email role placeWork contacts education stats isVerified createdAt updatedAt avatarId') // добавили avatarId
